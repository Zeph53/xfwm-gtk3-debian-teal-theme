...
####    This can be done by rebooting the system, logging out of your user account, changing your selected theme, or executing this one-liner to restart theme related processes:  
